          ...
          <tbody>
            {submissions.map((submission, index) => (
              <tr key={submission.id}>
                ...
                <td>
                  <span className="department-badge">{submission.department}</span>
                </td>
                <td>{formatSubmissionDate(submission.submittedAt)}</td>
                <td>
                  <div className="table-actions">
                    <button className="small-button" onClick={() => onEdit(submission)} type="button">Edit</button>
                    <button className="small-button delete" onClick={() => onDelete(submission.id)} type="button">Delete</button>
                  </div>
                </td>
              </tr>
            ))}
